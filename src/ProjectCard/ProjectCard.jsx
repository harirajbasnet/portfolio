...
{projectName.map((items) => {  
  const isLike = Like.some((m) => m.id === items.id)
  return(
  <div className='w-2xs md:w-xs border-1 border-lime-400 pt-3  text-xl md:text-2xl justify-center items-center flex flex-col  gap-3 bg-zinc-300  rounded-xl mt-10 overflow-hidden 'key={items.id} >
